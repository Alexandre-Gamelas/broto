...
SET id_utilizadores = ?, nome = ?, email = ?, ref_nacionalidades = ?, ref_papeis = ?, data_nascimento = ?, data_entrada = ?, fotografia = ? WHERE id_utilizadores LIKE ?";

if (mysqli_stmt_prepare($stmt, $query)) { // Prepare the statement

    mysqli_stmt_bind_param($stmt,'isssssssi', $id, $nome,$email, $nacionalidade, $papel, $data_nascimento, $data_entrada, $fotografia, $id); // Bind variables by type to each parameter
