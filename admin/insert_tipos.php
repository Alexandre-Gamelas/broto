    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">TIPOS DE CATEGORIAS</h1>
                ...
                <div class='card shadow mb-4'>
                    <div class='card-header py-3'>
                        <h6 class='m-0 font-weight-bold text-success'>Inserir Novo Tipo de Categorias</h6>

                    </div>
                    <div class='card-body'>
                        <form class='form row justify-content-center align-items-center' id='form_evento' method='post'
                              action='scripts\inserir_tipos.php'>

                            <div class="form-group col-8 mt-2">
                                <label for="">ID</label>
                                <input readonly class='form-control inputRegistar' type='text' name='id_tipos'
                                       placeholder='Gerado Automaticamente' value=''>
                            </div>

                            <div class="form-group col-8 mt-2">
                                <label for="">Nome</label>
                                <input autofocus class='form-control inputRegistar' type='text' name='nome_tipo'
