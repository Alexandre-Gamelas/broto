...
<div class="row justify-content-center mt-4 mb-5">
    <button class="col-8 cem-broto gradient-broto button-1-broto text-white mr-3 ">A seguir</button>

</div>
<?php
$link = new_db_connection();
$stmt = mysqli_stmt_init($link);
$query = "SELECT id_utilizadores, nome, email, fotografia FROM utilizadores INNER JOIN utilizadores_has_amigos ON id_utilizadores=ref_amigos WHERE ref_utilizadores = ? ";
