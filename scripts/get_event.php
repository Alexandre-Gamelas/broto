...
$query = "SELECT eventos.nome, data_inicio, data_fim, eventos.descricao, participantes, alcance, fotografia, inscricao, categorias.nome, acessibilidade.descricao FROM eventos
...
if (mysqli_stmt_prepare($stmt, $query)) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        mysqli_stmt_bind_result($stmt, $nome, $data_inicio, $data_fim, $descricao, $participantes, $alcance, $fotografia, $inscricao, $categoria, $acessibilidade);
